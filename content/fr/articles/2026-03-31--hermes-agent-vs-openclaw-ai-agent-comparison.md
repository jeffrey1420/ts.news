...
L'architecture technique est construite autour d'une base de code Python modulaire avec des sous-systèmes distincts : la boucle agent (`AIAgent` dans `run_agent.py`), un système d'assemblage et de compression de prompts, un résolveur de runtime provider supportant [OpenRouter](/articles/2026-06-14--openrouter-fusion-compound-ai-draco), OpenAI, Anthropic, Nous Portal, z.ai/GLM, [Kimi](/articles/2026-06-12--kimi-k2-7-code-mimo-code)/Moonshot et MiniMax, un runtime d'outils avec 40+ outils intégrés, une passerelle de messagerie pour les adaptateurs de plateforme, et un sous-système RL/environnements pour la génération de trajectoires et l'entraînement de modèles.
