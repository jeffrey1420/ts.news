...
faq:
  ...
  - question: "Pourquoi Anthropic est-elle en désaccord avec l'ordre ?"
    answer: "Anthropic indique que le gouvernement a fourni une preuve verbale d'un jailbreak étroit et non universel : demander au modèle de lire une base de code spécifique et d'identifier des failles logicielles. Anthropic a examiné le rapport sous-jacent et conclu que la capacité montrée est largement disponible dans d'autres modèles publics, dont GPT-5.5 d'OpenAI, et qu'il s'agit de la même capacité que les défenseurs utilisent chaque jour. Pour Anthropic, retirer un modèle commercial sur ce type de constat reviendrait, en pratique, à stopper tout nouveau déploiement de modèle de pointe dans l'industrie."
