...
It survived 27 years of human security research. Thousands of CVEs were filed and patched. Countless auditors, penetration testers, and independent researchers looked at the code. And then, in a matter of minutes, an AI model found a remote crash vulnerability in OpenBSD, one that required no authentication whatsoever. Within days, the exploit was written and the patch was live. That is the story of Claude [Mythos](/articles/2026-06-12--fable-5-distillation-guardrails) Preview and Project Glasswing.
...
![Claude Mythos Preview vs Opus 4.6 on CyberGym and SWE-bench Verified](/images/charts/glasswing-benchmarks.png)
