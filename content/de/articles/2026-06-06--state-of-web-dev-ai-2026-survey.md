...
1. **Jobverlust**: 41%
2. **Militärischer KI-Einsatz**: 39%
3. **Umweltauswirkungen**: 34%
4. **KI-Slop-Übernahme**: 29%
5. **Negative kognitive Auswirkungen**: 25%

Auf der praktischen Seite sind die häufigsten Reibungspunkte bei der Nutzung von KI-Tools :

1. **Halluzinationen und Ungenauigkeiten**: mit Abstand das meistgenannte Problem, um 8 Punkte gestiegen
2. **Codequalität**
3. **Kontextmangel** bezüglich der Codebasis
4. **Datenschutzbedenken** beim Senden von Code an Drittanbieter-APIs
